...
<header>
   ...
   <img class="img" src="../../assets/images/icon/logo.png" alt="logo">
        ...
        <nav>
            <ul class="nav-links">
            <li><a href="../../management/clientes/register.php">Cadastro de Clientes</a></li>
                <li><a href="../../management/veiculos/register.php">Cadastro de Veículos</a></li>
                <li><a href="../../movimento/index.php">Entradas/Saídas</a></li>
                <li><a href="../../relatorio/index.php">Relatórios</a></li>
                <li><a href="../../management/veiculos/horarios.php">Horarios</a></li>
